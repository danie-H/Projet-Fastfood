                                                    ...
                                                    <div class="container">
                                                      <div class="row slider-text justify-content-center align-items-center">
                                                        ...
                                                        <div class="col-md-7 col-sm-12 text-center ftco-animate">
                                                            <h1 class="mb-3 mt-5 bread">Faites votre réservation</h1>
                                                ...
                                                <section class="ftco-section contact-section">
                                                  <div class="container mt-5">
                                                    ...
                                                    <div class="row">
                                                              ...
                                                              <h2 class="h4">Choisissez une date</h2>
                                                                <br>
                                                      ...
                                                      <div class="col-md-6 ">
                                                          <h2 class="h4">Choisissez une heure</h2>
                                                          <br>
                                                    ...
                                                    <div class="row">
                                                      <div class=col-md-6>
                                                          <h2 class="h4">Nombres de personnes</h2>
                                                          <br>
                                                          
                                                        Nombre: <input type="text" name="nbrpers">
                                                      </div>
